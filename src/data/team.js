...
const management = [
    ...
    {
        name: "Ry Sothita",
        role: ["Media - oversees social media pages", "Finance - in charge of holding the finance of the project", "Proposal - helps monitor and provide support documents relate to sponsorships"],
        image: RySothita
    },
    {
        name: "Heng Veasna",
...
const organizers = [
    {
        ...
        people: [
            {
                name: "Yan Sovanpisoth",
                role: "Web Developer",
                image: sovanpisoth
            },
            {
                name: "Nget Sokunkanha",
                role: "Web Developer",
                image: sokunkanha
            },
            {
    ...
    {
        name: "proposal",
        title: "Meet Our Proposal Writers",
        people: [
            {
                name: "Khy Chhoungech",
    ...
    {
        name: "db-project",
        title: "Meet Our DB project Members",
        people: [
            {
                name: "Tong Sokhan",
                role: "DB Project Lead",
                image: sokhan
            },
            {
                name: "Lim Ingi",
                role: "DB Project Member",
                image: ingi
            }
        ]
    },
    {
        name: "cs-project",
        title: "Meet Our CS project Members",
        people: [
            {
                name: "Rath Phavy",
            ...
            {
                name: "Seng Chansreybopha",
                role: "CS Project Member",
                image: chansreybopha
            },
            {
                name: "Veng Devit",
    ...
    {
        name: "tn-project",
        title: "Meet Our TN project Members",
        people: [
            {
                name: "Sin Hong",
                role: "TN Project Lead",
                image: hong
            },
            {
                name: "Say Kokann",
                role: "TN Project Member",
                image: kokann
            },
            {
                name: "Horn Sovisal",
    ...
    {
        name: "db-trainer",
        title: "Meet Our DB Trainer Members",
        people: [
            {
                name: "Heng Nisay",
                role: "DB Trainer Lead",
                image: nisay
            },
            {
                name: "Eam Linsophary",
                role: "DB Trainer Member",
                image: linsophary
            },
        ]
    },
    {
        name: "cs-trainer",
        title: "Meet Our CS Trainer Members",
        people: [
            {
                name: "Chhim Soksambath",
                role: "CS Trainer Lead",
                image: soksambath
            },
            {
                name: "Ly Kimheng",
                role: "CS Trainer Member",
                image: kimheng
            },
            {
                name: "Keo Monikesar",
    ...
    {
        name: "tn-trainer",
        title: "Meet Our TN Trainer Members",
        people: [
            {
                name: "Rann Soumey",
                role: "TN Trainer Lead",
                image: soumey
            },
            {
                name: "Nov Sokpanha",
                role: "TN Trainer Member",
                image: sokpanha
            },
            {
                name: "Chom Devid",
