        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="text-black flex flex-col justify-center items-center text-center px-4">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <button className={`text-white w-full p-3 rounded-2xl hover:cursor-pointer hover:opacity-90`} style={{backgroundColor: qrColor}} onClick={() => window.open(url, "_blank", "noopener,noreferrer")}>Open URL</button>
                </div>
            </div>
        </Modal>
    );
