...
const PeopleCard = ({ name, role, image }) => {
    return (
        <div className="flex flex-col items-center gap-4 group relative">
            ...
            <div className="text-white opacity-0 group-hover:opacity-100 absolute transition-opacity duration-300 flex flex-col justify-end items-start h-full w-full bg-brand-primary/60 to-transparent p-4 flex flex-col gap-2">
