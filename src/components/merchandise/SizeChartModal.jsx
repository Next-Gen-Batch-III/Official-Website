...
import { getMerchandiseSizeChart, merchandiseSizeChart } from "@/data/merchandise";

const SizeChartModal = ({ isOpen, onClose, product, productId }) => {
  const chart = product || productId
    ? getMerchandiseSizeChart(product?.id || product?.slug || productId)
